...
using DockService.App.Messaging;
using DockService.Core.Messaging;
using DockService.Infrastructure.DI;
using System;
using System.IO;
using System.Threading;
using Utf8Json.Resolvers;

namespace DockService.App
{
    class Program
    {
    ...
    private static void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddTransient<IEventHandlerCallback, DockEventHandler>();
    }
